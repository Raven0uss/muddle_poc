const html_validationAccount = ({ firstname, lastname, token }) => {
  return `
...
<h1 style="color:#555555;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:23px;font-weight:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><strong>Merci pour votre inscription !</strong></h1>
</td>
</tr>
</table>
...
<p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;">Afin de pouvoir vous connecter et profiter de Muddles merci de valider votre compte en cliquant sur le lien ci-dessous. Si aucune fenêtre ne s'ouvre, veuillez copier le lien et le coller dans la barre d'adresse de votre navigateur.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
export default html_validationAccount;
